...
/*
    ...
    Constants, mostly precomputed attack bitboards, used by the engine 
    The definitions are generated by a precompile program
...
// unrestricted rook and bishop controls, without edge squares 
